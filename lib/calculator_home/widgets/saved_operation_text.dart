...
class SavedOperationText extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var firstOperand = savedOperation.firstOperand.limitSymbolsAfterDot();
    var secondOperand = savedOperation.secondOperand.limitSymbolsAfterDot();
    var result = savedOperation.result.limitSymbolsAfterDot();
