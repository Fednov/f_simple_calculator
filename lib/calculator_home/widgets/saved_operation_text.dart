...
class SavedOperationText extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var firstOperand = savedOperation.firstOperand.limitDecimalPlaces();
    var secondOperand = savedOperation.secondOperand.limitDecimalPlaces();
    var result = savedOperation.result.limitDecimalPlaces();
